<%-- 
    Document   : reporteAgotados
    Created on : Jun 27, 2012, 12:56:05 AM
...
<%
  Class.forName("com.mysql.jdbc.Driver");
        ...
        ResultSet resultado;
        String parametros = "SELECT upc, descripcion, precio, cantidad, tipo FROM Producto WHERE cantidad=0";
